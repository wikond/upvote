...
const clickActions = (e) => {
    ...
    if ((e.target.closest('button') !== null) && ($myBoard.boardID !== 0)) {
        ...
        if (e.target.closest('button').classList.contains('taskAddBtn')) {
            ...
            let newTaskObj = new Task($myBoard.boardID, $myBoard.nameID, $myBoard.pinID, 'headerTxt', 'As a... I want... so that...', 1, 1, 0, taskID, 1, owner, timeStamp);
            $taskMap.set(taskID, newTaskObj);
